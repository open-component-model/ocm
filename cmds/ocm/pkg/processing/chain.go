...
func Chain(ctx ocm.Context) ProcessChain {
	return (&_ProcessChain{}).new(ctx, nil, nil)
}

func (this *_ProcessChain) new(ctx ocm.Context, p *_ProcessChain, creator stepCreator) *_ProcessChain {
	if p != nil {
		if p.creator != nil {
			this.parent = p
...
func (this *_ProcessChain) Transform(t TransformFunction) ProcessChain {
	...
	return (&_ProcessChain{}).new(this.ctx, this, chainTransform(t))
}
...
func (this *_ProcessChain) Explode(e ExplodeFunction) ProcessChain {
	...
	return (&_ProcessChain{}).new(this.ctx, this, chainExplode(e))
}
...
func (this *_ProcessChain) Map(m MappingFunction) ProcessChain {
	...
	return (&_ProcessChain{}).new(this.ctx, this, chainMap(m))
}
...
func (this *_ProcessChain) Filter(f FilterFunction) ProcessChain {
	...
	return (&_ProcessChain{}).new(this.ctx, this, chainFilter(f))
}
...
func (this *_ProcessChain) Sort(c CompareFunction) ProcessChain {
	...
	return (&_ProcessChain{}).new(this.ctx, this, chainSort(c))
}

func (this *_ProcessChain) WithPool(p ProcessorPool) ProcessChain {
	return (&_ProcessChain{}).new(this.ctx, this, chainWithPool(p))
}

func (this *_ProcessChain) Unordered() ProcessChain {
	return (&_ProcessChain{}).new(this.ctx, this, chainUnordered)
}

func (this *_ProcessChain) Parallel(n int) ProcessChain {
	return (&_ProcessChain{}).new(this.ctx, this, chainParallel(n))
}
...
func (this *_ProcessChain) Append(p ProcessChain) ProcessChain {
	...
	return (&_ProcessChain{}).new(this.ctx, this, chainApply(p))
}
...
var initial = Chain(ocm.DefaultContext())
