...
import (
	...
	"github.com/open-component-model/ocm/v2/pkg/contexts/config/config"
	...
	handlercfg "github.com/open-component-model/ocm/v2/pkg/contexts/ocm/transfer/transferhandler/config"
