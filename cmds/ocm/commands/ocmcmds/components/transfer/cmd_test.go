...
import (
	...
	"github.com/open-component-model/ocm/api/config/extensions/config"
	...
	handlercfg "github.com/open-component-model/ocm/api/ocm/tools/transfer/transferhandler/config"
