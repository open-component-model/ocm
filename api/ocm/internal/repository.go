...
type ComponentVersionAccess interface {
	...
	SetResourceBlob(meta *ResourceMeta, blob BlobAccess, hints refhints.AnyReferenceHint, global AccessSpec, opts ...BlobModificationOption) error
	...
	// when adding a local blob to store them as implicit hints.
	SetSourceBlob(meta *SourceMeta, blob BlobAccess, hints refhints.AnyReferenceHint, global AccessSpec, opts ...TargetElementOption) error
