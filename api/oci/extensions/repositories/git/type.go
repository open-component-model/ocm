...
type RepositorySpec struct {
	...
	// Commit is the commit hash of the RepositoryImpl inside the Ref to resolve artifacts.
	// If empty, the default is set to the latest commit (the HEAD) of the Ref.
