...
---
title: ocm_ocm_commontransportarchive_transfer
url: /docs/cli-reference/ocm_ocm_commontransportarchive_transfer/
...
toc: true
---
## ocm ocm commontransportarchive transfer &mdash; Transfer Component Archive To Some Component Repository

### Synopsis

```
ocm ocm commontransportarchive transfer [<options>]  <source> <target>
```
