...
func Open(ctx ocm.Context, acc accessobj.AccessMode, path string, mode vfs.FileMode, opts ...accessio.Option) (ocm.Repository, error) {
...
func Create(ctx ocm.Context, acc accessobj.AccessMode, path string, mode vfs.FileMode, opts ...accessio.Option) (ocm.Repository, error) {
