...
import (
	...
	"github.com/open-component-model/ocm/pkg/ocm/accessmethods/ociblob"
	"github.com/open-component-model/ocm/pkg/ocm/accessmethods/ociregistry"
	storagecontext "github.com/open-component-model/ocm/pkg/ocm/blobhandler/oci"
	"github.com/open-component-model/ocm/pkg/ocm/blobhandler/oci/ocirepo"
...
var _ = Describe("component repository mapping", func() {
	...
	It("imports artefact", func() {
		...
		// create artefactset
		r, err := artefactset2.FormatTGZ.Create("test.tgz", accessio.AccessOptions(accessio.PathFileSystem(tempfs)), 0700)
		Expect(err).To(Succeed())
		testhelper.DefaultManifestFill(r)
		r.Annotate(artefactset2.MAINARTEFACT_ANNOTATION, "sha256:"+testhelper.DIGEST_MANIFEST)
