...
// NewLocalBlobAccessSpec creates a new localFilesystemBlob accessor.
func NewLocalBlobAccessSpec(path, name string, mediaType string, global cpi.AccessSpec) *LocalBlobAccessSpec {
