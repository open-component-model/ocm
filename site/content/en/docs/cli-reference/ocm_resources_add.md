...
---
title: ocm_resources_add
url: /docs/cli-reference/ocm_resources_add/
...
toc: true
---
## ocm resources add &mdash; Add Resources To A Component Version

### Synopsis

```
ocm resources add [<options>] <target> {<resourcefile> | <var>=<value>}
```
